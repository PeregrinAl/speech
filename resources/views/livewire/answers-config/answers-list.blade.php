<div>
    ...
    <textarea wire:model="description" class="flex w-full my-3 rounded-lg border-2 border-gray-300 hover:border-indigo-300"></textarea>
    ...
    @foreach($rows as $index => $row)
        <div class="grid grid-cols-5 gap-4 place-items-center">
            ...
            <!-- картинка к ответу -->
            <input name="answer_picture" type="file" wire:model="rows.{{ $index }}.file1" class="text-sm text-grey-500
